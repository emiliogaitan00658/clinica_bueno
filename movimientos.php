    ...
    <div class="modal-dialog modal-lg">
        ...
        <form class="form form-material" method="post" action="#" name="savemovimiento" id="savemovimiento">
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="form-group has-feedback">
                        <label class="control-label">Método de Movimiento: <span class="symbol required"></span></label>
                        <i class="fa fa-bars form-control-feedback"></i>
                        <input type="hidden" name="mediomovimientobd" id="mediomovimientobd">
                        <select name="mediomovimiento" id="mediomovimiento" class="form-control" required="" aria-required="true">
                            <option value=""> -- SELECCIONE -- </option>
