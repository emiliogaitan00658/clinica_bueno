...
<!--############################## MODAL PARA VER CARGA MASIVA DE PRODUCTOS ######################################-->
<!-- sample modal content -->
<div id="myModalCargaMasiva" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        ...
        <div class="modal-footer">
            ...
            <button type="button" onClick="ModalProducto()" class="btn btn-info" data-dismiss="modal"><span class="fa fa-times-circle"></span> Cerrar</button>
        </div>
    </form>
