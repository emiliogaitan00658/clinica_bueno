...
<div class="row">
    ...
    <form class="form form-material" method="post" action="#" name="kardexserviciosvalorizadoxfechas" id="kardexserviciosvalorizadoxfechas">
...
<?php } ?>
                    ...
                    <div class="text-right">
                        <button type="button" onClick="BuscaKardexServiciosValorizadoFechas()" class="btn btn-danger"><span class="fa fa-search"></span> Realizar Búsqueda</button>
                    </div>
                </div>
            </div>
        </form>
...
<div id="muestrakardexserviciosfechas"></div>
