                ...
                <div class="row"> 
                    ...
                    <div class="col-md-4">
                        <div class="form-group has-feedback">
                            ...
                            <i class="fa fa-bars form-control-feedback"></i>
                        <select name="nivel" id="nivel" class="form-control" required="" onChange="CargarSucursalesUsuarios(this.form.nivel.value);" aria-required="true">
                                <option value=""> -- SELECCIONE -- </option>
                        ...
                        <div class="form-group has-feedback">
                            <div class="fileinput fileinput-new" data-provides="fileinput">
                                <div class="form-group has-feedback"> 
                                    ...
                                    </div><small>Para Subir la Foto de Usuario debe tener en cuenta:<br> * La Fotografia debe ser extension.jpg<br> * La imagen no debe ser mayor de 50 KB</small>
                                </div>
                            </div>
                        </div> 
                    </div>
