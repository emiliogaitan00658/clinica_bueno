                ...
                <div class="row">
                    <div class="col-md-3">
                        <div class="form-group has-feedback">
                            ...
                            <input type="text" class="form-control" name="dni" id="dni" onKeyUp="this.value=this.value.toUpperCase();" placeholder="Ingrese Nº de Documento" autocomplete="off" value="<?php echo $_SESSION['dni']; ?>" disabled="" aria-required="true"/> 
                    ...
                    <div class="col-md-3">
                        <div class="form-group has-feedback">
                            ...
                            <input type="text" class="form-control" name="usuario" id="usuario" onKeyUp="this.value=this.value.toUpperCase();" placeholder="Ingrese Usuario de Acceso" autocomplete="off"
                            <?php if ($_SESSION["acceso"] == "especialista" || $_SESSION["acceso"] == "paciente") { ?> value="<?php echo $_SESSION['usuario']; ?>" disabled="" <?php } else { ?> value="<?php echo $_SESSION['usuario']; ?>" required="" aria-required="true" <?php } ?>/>  
