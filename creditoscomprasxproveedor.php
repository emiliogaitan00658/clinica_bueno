    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header bg-danger">
                <h4 class="modal-title text-white" id="myModalLabel"><i class="fa fa-pencil"></i> Detalle de Compra</h4>
        ...
        <form class="form form-material" name="saveabonosproveedor" id="saveabonosproveedor" action="#">
            ...
            <div class="modal-footer">
                ...
                " class="close" data-dismiss="modal" aria-hidden="true"><span class="fa fa-trash-o"></span> Cerrar</button>
            </div>
        </form>
