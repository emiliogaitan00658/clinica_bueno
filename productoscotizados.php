        ...
        <div class="page-wrapper">
            ...
            <div class="page-breadcrumb border-bottom">
                <div class="row">
                    ...
                    <h5 class="font-medium text-uppercase mb-0"><i class="fa fa-tasks"></i> Productos Cotizados</h5>
                    </div>
...
<div class="row">
    <div class="col-lg-12">
        <div class="card">
            <div class="card-header bg-danger">
                <h4 class="card-title text-white"><i class="fa fa-tasks"></i> Productos Cotizados</h4>
            </div>
            
        <form class="form form-material" method="post" action="#" name="productoscotizados" id="productoscotizados">
    ...
    <?php } ?> 
                    ...
                    <div class="text-right">
                        <button type="button" onClick="BuscaProductosCotizados()" class="btn btn-danger"><span class="fa fa-search"></span> Realizar Búsqueda</button>
                    </div>
                </div>
            </div>
        </form>
...
<div id="muestraproductoscotizados"></div>
