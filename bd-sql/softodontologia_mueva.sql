...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 18-10-2022 a las 03:00:29
...
(17, 'E2', '1', 18, '4410205910005S', 'FRANCISCO AGUIRRE', '(584) 81228', 'MASCULINO', 15, 115, 'COSTADO SUR IGLESIA CAT&Oacute;LICA SEBACO', 'FRAN91AGUIRRE@GMAIL.COM', 'ENDODONCIA', '1991-05-02', '', '', '', '', '$2y$10$bUwrQQ5Tn7K.YRfRFLNJruR4rzGDJp54Mey.YubwMatHvkDwA4Sty'),
(20, 'E3', '2', 18, '1651907890001Y', 'EVELING PEREZ', '(869) 04955', 'FEMENINO', 15, 115, 'JUSGADO 1C 1/2 O', 'EVELINGPEREZ25@GMAIL.COM', 'ODONTOLOGA', '1989-07-19', '', '', '', '', '$2y$10$CEmq5GdvT9.03jiOMgv.1u/Dz06AuLIGgdhGeUnKh3IRo1DS.XqTW');
...
(2, 'P1', 18, '1', 'FRANCISCO', 'JOSE', 'AGUIRRE', 'AGUIRRE', '0000-00-00', '58481228', 'FRAN91AGUIRRE@GMAIL.COM', 'B RH+', 'CASADO(A)', 'ODONTOLOGO', 'MASCULINO', 'OTRO', 15, 115, 'COSTADO SUR IGLESIA CAT&Oacute;LICA SEBACO', '', '', '', '', '', '', '', '', '$2y$10$l8CxFbRPblq2RBUZCfDmZeE5Tg8YWf0R2P/0VIHpwR5CmFIf0g6r6'),
(3, 'P2', 18, '2', 'EVELING', 'MERCEDES', 'PEREZ', 'SOLORZANO', '1989-06-19', '86904955', '', 'O RH+', 'CASADO(A)', 'ODONTOLOGO', 'FEMENINO', 'OTRO', 15, 115, 'JUSGADO 1 1 AL OESTE', '', '', '', '', '', '', '', '', '$2y$10$p8GK2K45wbgPcaQnQLTsdOxZJ6LH8s2qwrR0Ty3sc5hmDxpI4pWQO'),
(4, 'P3', 18, '000001', 'DAISY', '', 'GARCIA', '', '0000-00-00', '5654', 'ASDFASD@G.COM', 'A RH+', 'SOLTERO(A)', '45654', 'FEMENINO', 'OTRO', 15, 115, 'ASDFASDF', '', '', '', '', '', '', '', '', '$2y$10$0qOhVQZrYWPF3R/KO7LIFO1PeKwXzy3GZ2ekE74eotPzUuByjwlOq'),
(5, 'P4', 18, '3', 'JAIME', '', 'GONGORA', 'GARCIA', '2021-12-03', '21555', 'SDFASDFS@GMAIL.COM', 'A RH+', 'SOLTERO(A)', 'AAFSADF', 'MASCULINO', 'OTRO', 0, 0, 'ASDFASDF', '', '', '', '', '', '', '', '', '$2y$10$edPVEXSRkLhWdmpQPcHkueHB9YNiyo0Ccmmdd156t1otzliJGk54S'),
(6, 'P5', 18, '9843947419', 'MAYELA', '', 'LOPEZ', '', '0000-00-00', '584444', 'clinica@gmail.com', '00', 'SIN DETALLES', '255', 'FEMENINO', 'OTRO', 15, 115, 'KKK', '', '', '', '', '', '', '', '', '$2y$10$HHHDSzSKVKolMo.Sv1vjku.XWR8hiKJDVqBdJa6PBzlDy4g8Q9chy');
...
(3, '00032552', 1, '4492209630001Y', 'CLIMEDENSE', 15, 115, 'COSTADO SUR IGLESIA CAT&Oacute;LICA SEBACO', 'FRAN91AGUIRRE@GMAIL.COM', '() ', '01', '01', '01', '01', '2021-11-29', 'SI', 1, '4492209630001', 'FRANCISCO J. AGUIRRR V.', '() ', '0.00', 9, 1);
...
--
ALTER TABLE `accesosxsucursales`
  MODIFY `codaccesoxsuc` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=40;
...
--
ALTER TABLE `detalle_ventas`
  MODIFY `coddetalleventa` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
...
--
ALTER TABLE `horarios`
  MODIFY `codhorario` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;
...
--
ALTER TABLE `kardex`
  MODIFY `codkardex` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=32;
...
--
ALTER TABLE `provincias`
  MODIFY `id_provincia` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=118;
