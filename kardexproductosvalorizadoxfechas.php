   ...
   <!-- ============================================================== -->
    ...
    <div id="main-wrapper" data-layout="vertical" data-navbarbg="skin6" data-sidebartype="full" data-boxed-layout="full" data-boxed-layout="boxed" data-header-position="fixed" data-sidebar-position="fixed" class="mini-sidebar">              
        ...
        <div class="page-wrapper">
            ...
            <h5 class="font-medium text-uppercase mb-0"><i class="fa fa-tasks"></i> Kardex por Fechas</h5>
                    </div>
...
<div class="row">
    ...
    <form class="form form-material" method="post" action="#" name="kardexproductosvalorizadoxfechas" id="kardexproductosvalorizadoxfechas">
...
<?php } ?>
                    ...
                    <div class="text-right">
                        <button type="button" onClick="BuscaKardexProductosValorizadoFechas()" class="btn btn-danger"><span class="fa fa-search"></span> Realizar Búsqueda</button>
                    </div>
                </div>
            </div>
        </form>
...
<div id="muestrakardexproductosvalorizadofechas"></div>
