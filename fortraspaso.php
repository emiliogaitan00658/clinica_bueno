...
<form class="form form-material" method="post" action="#" name="updatetraspaso" id="updatetraspaso" data-id="<?php echo $reg[0]["codcotizacion"] ?>">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4"> 
                        <div class="form-group has-feedback"> 
                            ...
                            <input type="text" class="form-control" name="search_traspaso" id="search_traspaso" onKeyUp="this.value=this.value.toUpperCase();" autocomplete="off" placeholder="Ingrese Criterio de Búsqueda">
...
<a href="traspasos"><button class="btn btn-info" type="button"><span class="fa fa-trash-o"></span> Cancelar</button></a> 
